...
class CulturalHeritageSiteManager:
    ...
    def load_artifacts(self, filename=r"Cultural_new/file/cultural_heritage_artifacts.csv"):
    ...
    def load_visitors(self, filename=r"Cultural_new/file/cultural_heritage_visitors.csv"):
        data = pd.read_csv(filename)
        for _, row in data.iterrows():
